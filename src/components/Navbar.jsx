...
const Navbar = () => {
    ...
    return (
        <>
            <div className='w-full flex justify-between items-start gap-3 px-4 lg:px-2  mb-5 z-[99] bg-[#ffffff82]'>
                ...
                <div className={`w-[70%] md:w-[80%] px-3 text-md md:h-auto bg-white border-black border rounded-lg md:border-none md:bg-transparent ${clicked ? "inline-flex" : "hidden"} md:flex flex-col md:flex-row md:justify-between md:items-center gap-3 absolute md:static mt-14 md:mt-0 right-7`}>
                    <div className='w-full md:w-[60%] md:text-[10px] lg:text-md xl:text-lg flex flex-col md:flex-row justify-between items-center text-[20px] py-2'>
                        <NavLink to="/"
                            className={({ isActive }) => `${isActive ? "border border-black rounded-md hover:no-underline p-[3px] md:p-[5px]" : "text-black"} hover:underline hover:underline-offset-2 duration-300 ease-in-out w-full text-center`} onClick={() => setClicked(false)}
                    ...
                    <div className='w-full md:w-[40%] md:text-[10px] lg:text-md xl:text-lg flex flex-col md:flex-row justify-around items-center text-[20px] py-2'>
                        <NavLink to="wishList"
                            className={({ isActive }) => `${isActive ? "border border-black rounded-md hover:no-underline p-[3px] md:p-[5px]" : "text-black"} hover:underline hover:underline-offset-2 duration-300 ease-in-out w-full text-center`} onClick={() => setClicked(false)}
                        > WishList</NavLink>
                        <NavLink to="cart"
